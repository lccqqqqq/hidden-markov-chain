#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Tue  3 Mar 12:03:24 GMT 2026      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 nice -n 10 /usr/bin/env TRAIN_CONFIG=config/base_config_reversed.yaml /usr/bin/python3 -m wandb agent chuqiao-lin-university-of-oxford/hidden-markov-chain-src/z1517ttc
  echo ---------------                                           
